/*
 * Public API Surface of lib-hikes
 */

export * from './lib/lib-hikes.service';
export * from './lib/lib-hikes.component';
export * from './lib/lib-hikes.module';
...
export * from './lib/hikes.interface';
